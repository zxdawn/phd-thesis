...
其中对流层顶--330 hPa和330--450 hPa的云上NO$_2$高值区位于北美东南部、中国沿海地区、中国华北地区、墨西哥、巴拿马、
...
其在对流层顶--330 hPa （330--450 hPa）区间的NO$_2$浓度比TROPOMI的观测结果低10\%（50\%），
...
然而官方的TROPOMI NO$_2$柱浓度产品所依赖的NO$_2$先验廓线，并未详细考虑LNO$_2$的垂直分布，
...
可根据闪电活动（图\ref{fig:china_flash_scd}）对其进行分类：新生闪电区（MT $\Delta$AMF $<$ -20\%）、闪电下风向（MT $\Delta$AMF$_{\ch{trop}}$ $>$ 20\%）和闪电老化区（UT $\Delta$AMF$_\textrm{trop}$ $>$ 20\%）。
