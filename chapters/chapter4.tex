...
GLD360在70$^{\circ}$ N 以北探测到的夏季（6--8 月）闪击数分别为 1.2$\cdot$10$^6$ （2019）、1.6$\cdot$10$^6$ （2020） 和 9.8$\cdot$10$^5$ （ 2021）（表\ref{table:stroke_count}）。
...
\begin{table}[h]
\centering
\caption{2019--2021期间高纬度地区GLD360探测到的闪击数\\Table \ref{table:stroke_count}. The GLD360 stroke counts in high-latitude regions from 2019 to 2021.}
\label{table:stroke_count}
\begin{tabular}{rrrrr}
\hline
