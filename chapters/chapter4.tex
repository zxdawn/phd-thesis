...
（1）LNO$_2$ 在上对流层占主导，而污染 NO$_2$ 在下对流层占主导；

（2）在对流层上层（180$\sim$330 hPa和330$\sim$450 hPa），
...
（3）在对流层中层和低层，MERRA2-GMI在污染地区的NO$_2$偏高，尤其是中国东部和印度北部，鉴于全球模式偏低的对流垂直输送强度，我们将此归因于排放清单未及时更新；

（4）将不同LNO$_2$产率的WRF-Chem高分辨率结果代入TROPOMI NO$_2$柱浓度的计算，
敏感性试验结果表明如果先验廓线忽略LNO$_2$，NO$_2$柱浓度在新生闪电的区域会被低估，而在出流区和老化LNO$_2$的区域则相反。
