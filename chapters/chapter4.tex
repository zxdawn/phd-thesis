...
8 月 23 日黑点的值（未显示）为 1958\%。\\ (top) Time series of NO$_2$Vis, LNO$_2$Vis, LNO$_2$ and LNO$_2$Clean production per day over the CONUS for MJJA 2014 with CRF $\geq$ 90\% and a flash threshold of 2400 flashes per 2.4 h.
...
\begin{figure}[t]
    ...
    \caption{(a) Daily NO$_\textrm{2}$Vis, LNO$_\textrm{2}$Vis, LNO$_\textrm{2}$ and LNO$_\textrm{2}$Clean versus ENTLN total flashes data. (b) Same as (a) but for strokes. (c) Daily LNO$_\textrm{x}$Vis and LNO$_\textrm{x}$ versus total flashes. (d) Same as (c) but for strokes.}
    \label{fig:pe_linear}
\end{figure}
