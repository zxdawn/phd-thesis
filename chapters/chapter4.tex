...
在第\ref{sec:retrieval}章和\ref{sec:china}节中，本研究利用对流旺盛时的卫星观测来估算 LNO$_{\ch{x}}$产率。
...
\item 2019年和2020年中国东南部的两个对流个例分析表明，TROPOMI 的像素饱和效应
限制了对流旺盛区域的LNO$_{\ch{2}}$浓度估计，
因此本研究提出了计算消散阶段LNO$_{\ch{2}}$的方法。
通过该方法，我们得出了中国东南部的LNO$_{\ch{x}}$产率为 60 $\pm$ 33 mol NO$_{\ch{x}}$每闪电。
